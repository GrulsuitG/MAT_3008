...
#define DCONV(i) ((double)(i))

void d_machar(int* ibeta, int* it, int* irnd, int* ngrd, int* machep, int* negep,
...
int main(void)
{
	...
	double d_eps, d_epsneg, d_xmax, d_xmin;
	...
	d_machar(&ibeta, &it, &irnd, &ngrd, &machep, &negep, &iexp, &minexp, &maxexp,
